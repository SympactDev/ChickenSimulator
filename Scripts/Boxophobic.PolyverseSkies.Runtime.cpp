...
IL_0090:
	...
	}
	{
		...
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_22 = __this->get_skyboxDay_10();
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_23 = (Material_t8927C00353A72755313F046D0CE85178AE8218EE *)il2cpp_codegen_object_new(Material_t8927C00353A72755313F046D0CE85178AE8218EE_il2cpp_TypeInfo_var);
		Material__ctor_mD0C3D9CFAFE0FB858D864092467387D7FA178245(L_23, L_22, /*hidden argument*/NULL);
		// skyboxMaterial.Lerp(skyboxDay, skyboxNight, timeOfDay);
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_24 = L_23;
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_25 = __this->get_skyboxDay_10();
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_26 = __this->get_skyboxNight_11();
		float L_27 = __this->get_timeOfDay_12();
		NullCheck(L_24);
		Material_Lerp_m1A80EE6FD77F49F0A22DFBF2836D3E8359484CB0(L_24, L_25, L_26, L_27, /*hidden argument*/NULL);
		// RenderSettings.skybox = skyboxMaterial;
		RenderSettings_set_skybox_m452A88810ECA0D7B7B71DBA56E8D0D661CEEA237(L_24, /*hidden argument*/NULL);
	}

IL_00d4:
	{
		// if (updateLighting)
		bool L_28 = __this->get_updateLighting_13();
		if (!L_28)
		{
			goto IL_00e1;
		}
